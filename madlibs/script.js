...
let stories =
	...
	`<p>Since elections last week, ${place} has been engulfed in chaos. It all began when the results were thrown away and a ${adjective2} ${noun} was declared the winner. Since then, the president has gone into hiding, businesses have shut down, and there has been widespread ${verb} in the streets. A special appeal has been made to ${name} to intervene, and talks may soon be underway. But if those fail, what else can be done? One skeptical resident fleeing the country said, "If someone as ${adjective1} as ${name} can't save us, no one will."</p>`,
	`<p>I was feeling extremely ${adjective2}, so I went to the doctor to get checked out. After doing an x-ray, she said "I'm afraid you've swallowed a ${noun}. It's not uncommon in people who come back from ${place}. ${name} was in with the same thing just last week. I recommend a lot of ${verb} until you feel more ${adjective1}."</p>`]
