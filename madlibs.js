...
let stories =
	...
	`<p>I was feeling extremely ${adjective2}, so I went to the doctor to get checked out. After doing an x-ray, she said "I'm afraid you've swallowed a ${noun}. It's not uncommon in people who come back from ${place}. ${name} had the same thing just last week. I recommend a lot of ${verb} until you feel more ${adjective1}."</p>`]
